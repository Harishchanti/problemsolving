...
A single WBC can eliminate only one bacterial strain. Afterward, the WBC is exhausted and cannot perform any other tasks.
...
public class BacteriaStain {
    public static void main(String[] args) {
        ...
        while (!priorityQueue.isEmpty()) {
            ...
            totalTime = Math.max(totalTime, two + splitTime);

            priorityQueue.add(totalTime);
